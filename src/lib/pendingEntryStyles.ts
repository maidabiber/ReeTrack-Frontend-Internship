...
export const TIME_ENTRY_ROW_CLASS =
  'rounded-xl border border-brand/25 bg-white hover:border-brand/40 hover:bg-surface-muted/50 transition-colors'

/** Pending / invitation entry — stronger blue fill and border. */
export const PENDING_ENTRY_ROW_CLASS =
  'rounded-xl border border-brand/50 bg-[#d4def8] hover:border-brand/65 hover:bg-[#c5d4f4] transition-colors'
