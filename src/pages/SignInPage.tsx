...
export default function SignInPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white text-navy">
      ...
      <span aria-hidden="true" className="absolute right-[280px] bottom-[280px] h-[30px] w-[30px] -rotate-6 rounded-[9px] bg-brand-tint" />
      ...
      <div className="relative z-[2] w-[460px] max-w-full rounded-[25px] bg-brand-gradient p-px shadow-[0_30px_70px_rgba(31,43,77,0.14)]">
        <div className="flex flex-col items-center rounded-[24px] bg-white px-14 py-[52px] text-center">
          ...
          <h1 className="mb-3 font-display text-[28px] leading-[1.25] font-bold">Sign in</h1>
          ...
          {previewState === 'loading' && (
            <div className="mb-7 flex w-full items-center justify-center rounded-[14px] bg-surface-muted px-4 py-3">
              <span className="h-5 w-5 animate-spin rounded-full border-[3px] border-navy/20 border-t-navy" />
            </div>
          )}

          {previewState === 'loaded' && preview && (
            <div className="mb-7 flex w-full items-center gap-2.5 rounded-[14px] bg-surface-muted px-4 py-3">
          ...
          {previewState === 'invalid' && (
            <div className="mb-7 w-full rounded-[14px] bg-surface-muted px-4 py-3 text-left text-[13.5px] leading-[1.5] text-navy/75">
